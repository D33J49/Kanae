...
if __name__ == "__main__":
    with app.app_context():
        try:
            ...
            # ✅ Correct check for existing admin
            existing_admin = User.query.filter_by(matric_number="admin@csc").first()
            ...
            if not existing_admin:
                ...
                db.session.commit()
                print(
                    "[SUCCESS] Admin user created: matric_number='admin@csc', password='admin@csc123'"
                )
            else:
